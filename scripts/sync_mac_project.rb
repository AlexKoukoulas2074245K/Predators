...
project_path = '../prebuilt_mac/Predators/Predators.xcodeproj'

#open the xcode project
project = Xcodeproj::Project.open(project_path)

#find all relevant source files
files = Dir.glob(["../source_common/**/*.cpp", "../source_common/**/*.h", "../source_test/**/*.cpp", "../source_test/**/*.h", "../source_desktop/**/*.cpp", "../source_desktop/**/*.h", "../source_desktop/**/*.m", "../source_desktop/**/*.mm", "../source_apple_utilities/**/*.cpp", "../source_apple_utilities/**/*.h", "../source_apple_utilities/**/*.m", "../source_apple_utilities/**/*.mm"]).select{|file| !file.include? "main.cpp"}
