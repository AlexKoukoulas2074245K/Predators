...
static const std::unordered_map<strutils::StringId, std::vector<strutils::StringId>, strutils::StringIdHasher> FAMILY_STORY_STARTING_CARD_NAMES =
{
    ...
    { game_constants::DINOSAURS_FAMILY_NAME, { strutils::StringId("Meteor"), strutils::StringId("Triceratops"), strutils::StringId("Dilophosaurus"), strutils::StringId("Velociraptor") }},
    ...
    { game_constants::RODENTS_FAMILY_NAME,   { strutils::StringId("Bunny"), strutils::StringId("Squirrel"), strutils::StringId("Rodent Combo"), strutils::StringId("Guinea Pig") }},
