...
namespace game_constants
{
    ...
    inline const float IN_GAME_CARD_DAMAGE_ICON_SCALE = 0.04f;
    inline const float IN_GAME_CARD_DAMAGE_ICON_X_OFFSET = -0.014f;
    inline const float IN_GAME_CARD_DAMAGE_ICON_Y_OFFSET = 0.035f;
    inline const float IN_GAME_CARD_DAMAGE_SCALE = 0.00018f;
    inline const float IN_GAME_CARD_DAMAGE_Y_OFFSET = 0.0335f;
    inline const float IN_GAME_CARD_NAME_X_OFFSET = 0.004f;
    inline const float IN_GAME_CARD_NAME_Y_OFFSET = -0.0135f;
    ...
    inline const float IN_GAME_TOP_PLAYER_HELD_CARD_Y = 0.125f;
    inline const float IN_GAME_BOT_PLAYER_HELD_CARD_Y = -0.125f;
    inline const float IN_GAME_TOP_PLAYER_BOARD_CARD_Y = 0.037f;
    inline const float IN_GAME_BOT_PLAYER_BOARD_CARD_Y = -0.037f;
